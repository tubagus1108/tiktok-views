...
"""   
    ...
    def task(self) -> None:
        ...
        # Periksa apakah elemen sudah ada sebelum mencoba melakukan klik
        element_xpath = f'//*[@id="{self.paths[self.choice][1]}"]/div[1]/div/form/button'
        element_present = self.driver.find_elements(By.XPATH, element_xpath)
        if element_present:
            self.driver.execute_script(self.get_jsfunc(element_xpath))
